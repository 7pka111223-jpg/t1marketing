...
export default async function AnalyticsPage() {
  ...
  return <>
    <PageHeader title="Analytics" copy="Optimize for recognition and membership outcomes, not views alone. Content IDs follow users through app signup, booking and membership where attribution is available."/>
